/**
 * Live market data with in-memory caching to avoid hammering free APIs.
 * Crypto: CoinGecko (no key). FX: exchangerate.host (no key).
 */
...
const FALLBACK_FX: MarketQuote[] = [
  { symbol: "EURUSD", label: "EUR/USD", type: "FX", price: 1.082, changePct24h: 0.15, currency: "USD" },
  { symbol: "GBPUSD", label: "GBP/USD", type: "FX", price: 1.265, changePct24h: -0.22, currency: "USD" },
  { symbol: "USDJPY", label: "USD/JPY", type: "FX", price: 154.85, changePct24h: 0.31, currency: "JPY" },
  { symbol: "AUDUSD", label: "AUD/USD", type: "FX", price: 0.661, changePct24h: -0.18, currency: "USD" },
  { symbol: "USDCAD", label: "USD/CAD", type: "FX", price: 1.368, changePct24h: 0.05, currency: "CAD" },
  { symbol: "USDCHF", label: "USD/CHF", type: "FX", price: 0.905, changePct24h: -0.11, currency: "CHF" },
  { symbol: "NZDUSD", label: "NZD/USD", type: "FX", price: 0.611, changePct24h: -0.27, currency: "USD" },
  { symbol: "USDINR", label: "USD/INR", type: "FX", price: 83.42, changePct24h: 0.08, currency: "INR" },
];
